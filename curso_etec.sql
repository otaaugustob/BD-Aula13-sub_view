...
select id_cur 'Id Curso', nm_prof 'Nome Professor' , vl_hora_prof 'Valor Hora Profº(a)'
from professor;
...
as select nm_prof as 'Nome Professor', vl_hora_prof as 'Valor da Hora' , CONVERT(decimal(10, 2), vl_hora_prof + ((vl_hora_prof * 5) / 100) ) as 'Valor Hora com aumento'
FROM professor
